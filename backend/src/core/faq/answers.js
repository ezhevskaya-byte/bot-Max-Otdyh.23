...
export const FAQ_INTENTS = [
  ...
  },
  {
    ...
    text: 'Сделать чай или кофе можно на общей террасе — там есть термопот с горячей водой. В номерах мы не используем собственные чайники и другую нагревательную технику.'
  },
  {
    id: 'tea_in_room',
    knowledgeType: 'PUBLIC',
    ...
    text: 'Чай или кофе можно сделать на общей террасе — там есть термопот с горячей водой. В номерах чайники не предусмотрены.'
  },
  {
    id: 'microwave',
    knowledgeType: 'PUBLIC',
  ...
  },
  {
    ...
    text: 'На общей террасе организовано всё необходимое для приёма готовой еды: можно разогреть её в микроволновке, сделать чай или кофе и спокойно поесть. Полноценной кухни с плитой для самостоятельного приготовления у нас нет.'
  },
  {
    id: 'meals_in_rooms',
    knowledgeType: 'PUBLIC',
    ...
    text: 'Для приёма пищи у нас предусмотрена общая терраса — там можно удобно поесть и разогреть готовую еду. В комнатах мы просим пищу не принимать.'
  },
  {
    id: 'cooking',
    knowledgeType: 'PUBLIC',
