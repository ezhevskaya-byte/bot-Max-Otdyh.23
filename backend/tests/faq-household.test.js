...
describe('FAQ household: пакет №3', () => {
  describe('A. REFRIGERATOR', () => {
    it('«А холодильник в номере есть?» — мини-холодильник + терраса', () => {
    ...
    it('«Большой холодильник есть?» — мини в комнате, большие на террасе', () => {
  ...
  describe('B. TEA', () => {
    it('«А чай в номере можно сделать?» — без оправдательного хвоста', () => {
  ...
  describe('C. MICROWAVE', () => {
    it('«А еду разогреть где-нибудь можно?» — микроволновка без хвоста', () => {
  ...
  describe('D. MEALS', () => {
    it('«А покушать в номере можно?» — прямое правило + терраса', () => {
  ...
  describe('F. POOL', () => {
    it('«Бассейн есть?» — компактный pool_simple', () => {
      ...
      assert.doesNotMatch(result.text, /8,6/);
      assert.doesNotMatch(result.text, /спасател/i);
